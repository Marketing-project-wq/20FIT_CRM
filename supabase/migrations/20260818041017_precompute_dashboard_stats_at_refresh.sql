...
--
-- SALINAN PERSIS SQL yang berjalan. Dikonsolidasikan ke supabase/migrations/ pada
--   2026-08-21 (integrasi selektif dari branch sprint-1; konvensi main = semua migrasi CRM
--   di supabase/migrations/). `supabase db push` TETAP DILARANG — ledger diverge; berkas ini
--   REKAMAN REPO saja, JANGAN di-apply ulang (sudah distempel ledger 20260818041017). Ketiga
--   badan fungsi di bawah diambil VERBATIM dari pg_get_functiondef (katalog live), bukan dari
--   draf percakapan — hanya ';' penutup statement yang ditambahkan agar bisa dijalankan.
--
