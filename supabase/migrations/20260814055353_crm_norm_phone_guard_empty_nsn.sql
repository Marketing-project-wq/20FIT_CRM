...
--
-- SALINAN PERSIS SQL yang diterapkan (ledger 20260814055353), disalin verbatim dari PR #13
--   (branch claude/20fit-crm-sprint-1-67vvhs, docs/migrations-applied/). Di branch INI berkas
--   migrasi diletakkan di supabase/migrations/ berdampingan dengan migrasi 15/16 — konvensi
--   branch ini berbeda dari PR #13 (yang memakai docs/migrations-applied/). SUDAH di ledger
--   Supabase — JANGAN terapkan ulang; berkas ini rekaman repo dari definisi fungsi terkoreksi.
--
