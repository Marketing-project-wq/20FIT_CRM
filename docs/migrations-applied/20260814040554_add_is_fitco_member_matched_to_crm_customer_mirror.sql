...
--
-- BERKAS INI BUKAN DIJALANKAN ULANG OLEH CLI. Ia ada di docs/migrations-applied/,
--   BUKAN di supabase/migrations/, dengan sengaja — lihat ../migrations-applied/README.md
--   dan supabase/migrations/README.md. Ini SALINAN PERSIS SQL yang diterapkan, disimpan
--   agar definisi 20 kolom cermin hidup di repo, bukan hanya di ledger internal Supabase.
--
