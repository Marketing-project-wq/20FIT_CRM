 ...
 *       (docs/migrations-applied/20260814055353_crm_norm_phone_guard_empty_nsn.sql) dan
 *       memastikan guard empty-NSN masih ada di sana — menangkap regresi pada REKAMAN repo
 *       (bukan DB live). Pola meniru lib/crm/retention-policy.parity.test.ts.
 *
