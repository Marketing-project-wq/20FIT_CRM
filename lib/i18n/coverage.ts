...
export const BILINGUAL_SCREENS: ReadonlySet<ScreenId> = new Set<ScreenId>([
  ...
  "profile", // /audience/[id] profile detail — all sections + Why blocks routed through t.profile.* (Sprint 5B-T2); nuance under profile.warn.* guarded by warning-guards. Verified by untranslated-scan.
]);
