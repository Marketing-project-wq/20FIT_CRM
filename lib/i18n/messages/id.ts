...
export const id = {
  ...
  templatesPage: {
    ...
    categoryPromo: "Promo",
    categoryEvent: "Event",
    categoryNotification: "Notifikasi",
    categoryOther: "Lainnya",
    statusDraft: "Draf",
    statusActive: "Aktif",
    statusArchived: "Diarsipkan",
    cardVersion: "v{v}",
    cardNoDescription: "Belum ada deskripsi",
    emptyTitle: "Belum ada template",
    emptyBody: "Template email dan WhatsApp yang Anda buat akan muncul di sini.",
    emptyFiltered: "Tidak ada template yang cocok dengan filter.",
    createEmail: "Buat Email",
    createWhatsApp: "Buat WhatsApp",
    emailSection: "Email Templates",
    whatsAppSection: "WhatsApp Templates",
    preview: "Pratinjau",
    previewNewTab: "Pratinjau tab baru",
    edit: "Edit",
    delete: "Hapus",
    deleteConfirm: "Hapus template \"{name}\"? Tindakan ini menyembunyikannya dari daftar & pengiriman.",
    previewTitle: "Pratinjau Email",
    sentCount: "{n} terkirim",
    neverSent: "Belum pernah dikirim",
    duplicate: "Duplikat",
    archive: "Arsipkan",
    activate: "Aktifkan",
    archiveConfirm: "Arsipkan template \"{name}\"? Template tidak akan muncul di daftar pengiriman.",
    ...
    displayNamePlaceholder: "Nama yang terlihat di daftar template",
    descriptionLabel: "Deskripsi",
    descriptionPlaceholder: "Tujuan atau catatan singkat tentang template ini",
    categoryLabel: "Kategori",
    templateKeyLabel: "Kunci Template",
    templateKeyAuto: "Otomatis dari nama tampilan",
  },
  ...
  audience: {
    ...
    addContactDesc: "Isi data kontak. Email wajib diisi. Jika email sudah ada, data diperbarui dan tag digabung.",
    fldEmail: "Email",
    fldName: "Nama lengkap",
    fldPhone: "No. Telepon",
    fldGender: "Gender",
    ...
    genderL: "Laki-laki",
    genderP: "Perempuan",
    acPhEmail: "alamat@email.com",
    acPhName: "Nama lengkap kontak",
    acPhPhone: "mis. 0812… atau 62812…",
    acPhCity: "mis. Jakarta",
    selectPlaceholder: "— pilih —",
    addContactSubmit: "Simpan",
    addContactSubmitting: "Menyimpan…",
    addContactCancel: "Batal",
    addContactInserted: "Kontak baru ditambahkan.",
    addContactUpdated: "Kontak sudah ada, data diperbarui.",
    addContactFailed: "Gagal menyimpan kontak.",
    addContactEmailRequired: "Email wajib diisi.",
    addContactNameRequired: "Nama wajib diisi.",
  ...
  segments: {
    ...
    exclude: {
      title: "Pengecualian",
      intro: "Buang profil yang justru punya salah satu ciri ini — untuk segmen “X tapi bukan Y” (misalnya peserta event yang bukan anggota, belum pernah ke arena).",
      notMember: "Bukan anggota membership",
      neverArena: "Belum pernah ke arena",
      neverGym: "Belum pernah ke gym",
      neverHyrox: "Belum pernah ikut Hyrox",
      noApp: "Belum punya akun aplikasi",
      noRecency: "Tak ada aktivitas nyata di aplikasi",
      optionCount: "opsi",
    },
    tags: {
      title: "Tag",
      any: "cocok salah satu",
      all: "cocok semua",
      immediate: "Tag dari impor langsung bisa dipakai — tak perlu menunggu penyegaran cermin harian.",
      excludeTitle: "Kecualikan yang bertag",
      searchPlaceholder: "Cari tag… (mis. sportfest)",
      chipsHeading: "Tag terpilih",
      include: "sertakan",
      exclude: "kecualikan",
      remove: "hapus",
      anyMode: "cocok salah satu",
      allMode: "cocok semua",
      modeHint: "(berlaku untuk tag yang disertakan)",
      selectedOfValues: "{sel} dipilih · {n} nilai",
      peopleSuffix: "orang",
      noMatch: "Tak ada tag yang cocok dengan pencarian.",
    },
    filterReadable: "Filter terbaca: ",
    ...
    groupFilter: "Filter audiens",
    unifiedIntro: "Tambahkan kondisi satu per satu dari satu daftar — kontak, demografi, dan keikutsertaan. Semua digabung dengan DAN.",
    unifiedAdd: "+ Tambah kondisi…",
    unifiedYes: "ya",
    criteriaTitle: "Kriteria",
    aiTitle: "Asisten AI",
    aiOptional: "pintasan opsional",
    aiPrimary: "cara tercepat untuk syarat rumit",
    aiExamplesLabel: "Coba:",
    quickSeeAll: "Lihat semua",
    quickSeeLess: "Ringkas",
    groupProfil: "Profil",
    groupProfilHint: "Atribut profil orang — usia, tanggal lahir, gender, kota domisili, golongan darah.",
    profileAge: "Usia",
    profileDob: "Tanggal lahir",
    profileGender: "Gender",
    profileBloodType: "Golongan darah",
    profileCityLabel: "Domisili",
    ageOpGt: "lebih dari",
    ageOpLt: "kurang dari",
    ageOpEq: "sama dengan",
    ageOpBetween: "antara",
    ...
    genderL: "Laki-laki",
    genderP: "Perempuan",
    profileCaveat: "Usia & tanggal lahir hanya terisi untuk sebagian profil. Profil tanpa tanggal lahir tidak akan cocok dengan filter usia/DOB — bukan bug, melainkan batas data.",
    ...
    rbTagsAny: "bertag salah satu",
    rbTagsAll: "bertag semua",
    rbAndMore: "+{n} lainnya",
    rbWordCity: "kota",
  ...
  stubs: {
    ...
    workflows: "Mesin workflow marketing dengan sembilan guard. Aktif setelah kirim nyata diaktifkan.",
  },
  ...
  messagesPage: {
    ...
    emptyBody: "Log terisi begitu kampanye pertama berjalan. Kirim nyata masih nonaktif sampai diaktifkan operator.",
    ...
    causeThrottled: "Dibatasi penyedia (throttle)",
  ...
  workflowsPage: {
    ...
    errInactive: "Workflow non-aktif — aktifkan dulu sebelum menjalankan.",
    errNotFound: "Workflow tak ditemukan.",
    errResolve: "Gagal menghitung kandidat penerima.",
    errRunCreate: "Gagal membuat catatan pengiriman.",
    errSendThrew: "Kirim melempar sebelum selesai — periksa detail pengiriman.",
    errDenied: "Peran Anda tak berwenang menjalankan workflow.",
    fieldSource: "Sumber pemicu",
    sourcePool: "Profil baru di pool (cakupan penuh)",
    sourceActivity: "Aktivitas pertama (hanya 0,88% yang berjejak)",
    sourceNote: "Sambutan memakai pool = menyapa SETIAP pendaftar baru; aktivitas hanya menyapa yang sudah terekam beraktivitas.",
    pause: "Jeda",
    activate: "Aktifkan",
  ...
  tagRegistryPage: {
    title: "Registri tag",
    intro: "Kelola semua tag operator. Tag yang ditandai 'Tampil di chart' akan muncul di chart Event Spread di Dashboard.",
    loading: "Memuat tag…",
    loadFailed: "Gagal memuat registri tag.",
    retry: "Coba lagi",
    searchPlaceholder: "Cari tag…",
    allNamespaces: "Semua namespace",
    addTag: "Tambah tag",
    addTitle: "Tag baru",
    slugLabel: "Slug tag",
    labelField: "Label (opsional)",
    labelPlaceholder: "Label tampilan",
    showInChart: "Tampil di Event Spread",
    slugHint: "Format: namespace:value (contoh: event:my-event). Huruf kecil, angka, dan tanda hubung.",
    save: "Simpan",
    saving: "Menyimpan…",
    cancel: "Batal",
    edit: "Ubah",
    delete: "Hapus",
    errDuplicate: "Tag ini sudah terdaftar.",
    errInvalidSlug: "Format slug tidak valid. Gunakan namespace:value (huruf kecil, angka, tanda hubung).",
    errNetwork: "Gagal terhubung ke server.",
    colSlug: "Slug",
    ...
    footer: "Tag yang ditambahkan di sini tersedia sebagai autocomplete saat impor CSV. Hanya tag dengan tanda 'Tampil di Event Spread' yang muncul di chart Dashboard.",
  },
  tagAssignment: {
    title: "Tag tambahan",
    intro: "Tag yang dipilih di sini diterapkan ke semua baris — baik yang masuk maupun yang ditandai (sudah ada). Tag dari kolom CSV tetap berfungsi dan digabung dengan tag di sini.",
    loading: "Memuat tag…",
    noRegistry: "Belum ada tag terdaftar.",
    allSelected: "Semua sudah dipilih.",
    searchPlaceholder: "Cari…",
    addPlaceholder: "baru",
    addLabel: "Tambah tag baru",
    removeLabel: "Hapus",
    summaryTitle: "Tag tambahan yang akan diterapkan",
    summaryHint: "Ditambahkan ke semua baris yang masuk dan ditandai. Kembali ke pemetaan untuk mengubah.",
  },
  sendLimitsPage: {
    title: "Batas kirim",
    ...
    workflowHint: "Bagian dari batas harian yang boleh dipakai kiriman otomatis (workflow), agar tak menghabiskan jatah kampanye manual. Tak boleh melebihi batas harian.",
    save: "Simpan batas",
    saving: "Menyimpan…",
    saved: "Batas tersimpan.",
    saveFailed: "Gagal menyimpan batas.",
    errDailyInvalid: "Batas harian harus bilangan bulat positif.",
    errWorkflowInvalid: "Sub-batas workflow harus bilangan bulat positif.",
    errCapOverLimit: "Sub-batas workflow tak boleh melebihi batas harian.",
    errDenied: "Hanya Super Admin yang boleh mengubah batas kirim.",
    warnTitle: "Kenaikan besar — perhatikan reputasi domain",
    warnBody: "Domain 20fit.id belum punya riwayat pemasaran massal. Menaikkan batas jauh di atas nilai sebelumnya lalu mengirim banyak sekaligus berisiko memicu penyaringan spam — yang juga menyeret email transaksional (mis. reset kata sandi) ke spam. Ini peringatan, bukan penghalang; Anda tetap bisa menyimpan.",
  ...
  campaignsPage: {
    ...
    tabKirim: "Buat Kampanye",
    tabSegmen: "Segmen",
    tabKiriman: "Riwayat Pengiriman",
    tabUji: "Uji Kirim",
    deniedRole: "Peran Anda tidak memiliki akses untuk menyusun pengiriman.",
    deliveries: {
      subtitle: "Satu urutan waktu: yang akan datang, sedang berjalan, selesai, dan dihentikan. Sumbernya kiriman terjadwal dan pengiriman kampanye — digabung, bukan dua daftar.",
      empty: "Belum ada pengiriman. Kiriman terjadwal dan pengiriman kampanye akan muncul di sini.",
      stateUpcoming: "Akan datang",
      stateOverdue: "Terlambat",
      stateRunning: "Berjalan",
      stateDone: "Selesai",
      stateDoneWithNote: "Selesai dengan catatan",
      statePartial: "Sebagian gagal",
      partialNote: "{x} gagal",
      stateFailed: "Gagal",
      stateStopped: "Dihentikan",
      statePaused: "Jeda (batas harian)",
      stateStalled: "Macet? (tak ada kemajuan)",
      stateCancelled: "Dibatalkan",
      sourceManual: "Dibuat manual",
      sourceAuto: "Dari workflow",
      colName: "Kampanye",
      colOwner: "Segmen / Workflow",
      colTemplate: "Template",
      colRecipients: "Penerima",
      colFailed: "Gagal",
      colState: "Status",
      colWhen: "Waktu",
      unnamedRun: "Tanpa nama",
      ownerUnresolved: "Tak bisa diresolusi",
      cancel: "Batalkan",
      cancelConfirm: "Batalkan kiriman terjadwal ini?",
      cancelOk: "Kiriman terjadwal dibatalkan.",
      cancelFailed: "Gagal membatalkan — mungkin sudah berjalan.",
      resumeBtn: "Lanjutkan",
      resumeConfirm: "Lanjutkan pengiriman ini — kirim jatah hari ini di latar?",
      resumeOk: "Dilanjutkan — pengiriman dimulai lagi di latar dalam beberapa menit.",
      resumeFailed: "Gagal melanjutkan — mungkin sudah selesai atau sedang berjalan. Segarkan daftar.",
      stopBtn: "Hentikan",
      stopConfirm: "Hentikan pengiriman ini? Sisa penerima tidak akan dikirimi sampai Anda memulai pengiriman baru.",
      stopOk: "Dihentikan.",
      stopFailed: "Gagal menghentikan — mungkin sudah selesai. Segarkan daftar.",
      retryFailedBtn: "Kirim ulang gagal",
      retryFailedConfirm: "Kirim ulang ke {n} penerima yang gagal? Email yang sudah sampai tidak akan dikirim ulang.",
      retryFailedOk: "{n} penerima gagal dijadwalkan untuk pengiriman ulang di latar.",
      retryFailedFailed: "Gagal menjadwalkan pengiriman ulang. Segarkan dan coba lagi.",
      viewRecipients: "Lihat penerima",
      backToList: "← Kembali ke daftar",
      detailTitle: "Penerima pengiriman",
      recipientName: "Pelanggan",
      recipientEmail: "Email",
      recipientUnresolved: "Tak dikenal",
      recipientChannel: "Kanal",
      recipientStatus: "Status",
      recipientSentAt: "Waktu kirim",
      recipientDeliveredAt: "Waktu sampai",
      recipientOpenedAt: "Waktu buka",
      ...
      sumVersion: "Versi",
      sumTime: "Waktu",
      sumSentBy: "Dikirim oleh",
      sumStatus: "Status",
      audienceTitle: "Audiens",
      audMatched: "Cocok kriteria",
      audHasEmail: "Punya email",
      audSkipped: "Dilewati (suppression)",
      audSent: "Dikirimi",
      audienceMissing: "Angka audiens belum tercatat untuk pengiriman ini.",
      previewTitle: "Pratinjau email",
      previewVersionNote: "Ini isi versi {v} — yang benar-benar diterima penerima, bukan versi template terbaru.",
      previewNoVersion: "Isi versi terbaru (versi yang dikirim tak tercatat pada baris log).",
      previewMissing: "Isi template versi itu tak bisa ditemukan.",
      resultTitle: "Laporan hasil",
      resSent: "Terkirim",
      resSentSub: "Email dikirim ke provider",
      resDelivered: "Sampai",
      resDeliveredSub: "Dikonfirmasi sampai di inbox",
      resOpened: "Dibuka",
      resClicked: "Diklik",
      resBounced: "Memantul",
      resComplained: "Keluhan",
      resUnsub: "Berhenti langganan",
      resFailed: "Gagal",
      recipientsTitle: "Penerima",
      statSent: "Kirim",
      statDelivered: "Sampai",
      statOpened: "Buka",
      statClicked: "Klik",
      statBounced: "Pantul",
      statFailed: "Gagal",
      statOpenRate: "Rasio buka",
      statClickRate: "Rasio klik",
      ...
      engagementNote: "Buka & klik belum tercatat untuk pengiriman ini. Jika webhook sudah melanggan event Open dan Click, data akan muncul di sini begitu penerima berinteraksi.",
      engagementPending: "Data open & click akan muncul setelah penerima membuka atau mengklik link di email.",
      searchPlaceholder: "Cari nama atau email...",
      showingResults: "Menampilkan {x} dari {y} penerima",
      filterAll: "Semua",
      filterDelivered: "Sampai",
      filterSent: "Terkirim",
      ...
      searchCampaign: "Cari kampanye...",
      chipAll: "Semua",
      chipDone: "Selesai",
      chipSending: "Dikirim",
      chipFailed: "Gagal",
      chipDraft: "Terjadwal",
      showTest: "Tampilkan test",
      detailSectionTitle: "Detail",
      detailOwner: "Segmen / Workflow",
    ...
    emailListSegment: {
      tabFilter: "Filter otomatis",
      tabManual: "Daftar email manual",
      hint: "Tempel daftar email (mis. admin untuk uji). Segmen ini mengirim tepat ke alamat itu — tak perlu ada di master. Suppression tetap berlaku.",
      nameLabel: "Nama segmen",
      namePlaceholder: "mis. Tim Admin",
      emailsLabel: "Daftar email",
      emailsPlaceholder: "admin@20fit.id, tifany@20fit.id",
      countPre: "Terdeteksi ",
      countPost: " email valid",
      saveBtn: "Simpan segmen",
      saved: "Segmen tersimpan.",
      errName: "Nama wajib diisi.",
      errNoEmails: "Tak ada email valid.",
      errSave: "Gagal menyimpan segmen.",
      errTooMany: "Daftar terlalu panjang. Batas terukur 5.000 alamat per segmen; pecah jadi beberapa segmen.",
      pasteLabel: "Tempel daftar",
      uploadLabel: "Unggah CSV",
      uploadHint: "Berkas CSV — pemisah (koma/titik-koma) terdeteksi otomatis. Daftar pendek lebih cepat ditempel.",
      pickFile: "Pilih berkas CSV",
      columnLabel: "Kolom email",
      columnPickHint: "Berkas punya beberapa kolom — pilih kolom email.",
      previewBtn: "Pratinjau",
      previewing: "Memeriksa…",
      previewRead: "Alamat terbaca",
      previewMatched: "Cocok di pool (akan jadi penerima)",
      previewNotInPool: "Tidak ada di pool (tidak akan dikirimi)",
      previewSuppressed: "Ter-suppress (masuk hitungan, tapi takkan dikirimi)",
      previewFailed: "Gagal memeriksa. Coba lagi.",
      previewFirst: "Pratinjau dulu sebelum menyimpan — supaya angka penerima jelas lebih dulu.",
      notInPoolHint: "Alamat yang belum ada di pool TIDAK ditambahkan di sini (segmen manual hanya menunjuk orang yang sudah ada). Untuk menambahkannya, impor dulu lewat Audience → Impor.",
      snapshotNote: "Segmen daftar-email adalah POTRET: ia tidak ikut bertambah kalau orang baru masuk kemudian. Tanggal pembuatan ditambahkan otomatis ke namanya.",
      choiceHint: "Filter otomatis untuk yang berulang (event, peran). Daftar manual untuk yang sekali pakai (wave, slot jam).",
    },
    testRecipientsPanel: {
      title: "Penerima uji",
    ...
    steps: {
      ...
      step1GoToSegments: "Buat segmen baru di tab Segmen",
      ...
      step4Title: "4 · Kirim",
      step4Hint: "Pilih pengiriman, konfirmasi, dan kirim ke semua penerima. Jumlah dihitung ulang saat kirim.",
      step4SummarySuffix: "terkirim",
      progressStep: "Langkah",
      progressOf: "dari",
    },
    blockTitle: "Kirim nyata masih nonaktif",
    blockBody: "Pengiriman ke alamat pelanggan masih nonaktif (mode aman) sampai diaktifkan operator. Deliverability sudah siap. Saat diaktifkan: mulai dari segmen kecil ber-niat-tinggi lalu naikkan bertahap, dan auto-stop bounce menjaga reputasi domain. Sampai itu, hanya alamat internal @20fit.id yang bisa dikirimi.",
    ...
    composer: {
      ...
      noSegments: "Belum ada segmen tersimpan. Buat satu di tab Segmen.",
      ...
      runTitle: "Kirim sebagai pengiriman yang mana?",
      runHint: "Pengiriman baru mengirim ulang ke orang yang sama (terbitan berikutnya). Melanjutkan pengiriman yang ada melewati siapa pun yang sudah terkirim di pengiriman itu.",
      runResumeHeading: "Lanjutkan pengiriman yang ada",
      runNewHeading: "Mulai pengiriman baru",
      runResumeBadge: "LANJUTKAN",
      runNewBadge: "PENGIRIMAN BARU",
      runNoRuns: "Belum ada pengiriman untuk pasangan segmen + template ini.",
      runAutoNew: "Belum ada pengiriman sebelumnya untuk pasangan segmen + template ini — pengiriman baru akan dibuat otomatis saat kirim.",
      runUntitled: "Tanpa nama",
      runSentSuffix: "terkirim di pengiriman ini",
      runStatusDraft: "draf",
      runStatusSending: "berjalan",
      campaignNameField: "Nama kampanye",
      campaignNamePlaceholder: "mis. Newsletter Sept #1",
      campaignNameHint: "Dipakai untuk menelusuri kampanye ini di Riwayat Pengiriman.",
      errNameRequired: "Nama kampanye wajib diisi.",
      ...
      runChooseFirst: "Pilih dulu: lanjutkan pengiriman atau mulai baru.",
      sendNow: "Kirim sekarang",
      scheduleLabel: "Jadwalkan",
      scheduleDate: "Tanggal (WIB)",
      scheduleTime: "Jam (WIB)",
      scheduling: "Menjadwalkan…",
      scheduleBtn: "Jadwalkan kirim",
      scheduledOk: "Terjadwal untuk",
      schedulePast: "Waktu harus di masa depan.",
      scheduleBadTime: "Isi tanggal dan jam yang valid.",
      sendBtn: "Kirim",
      sending: "Mengirim…",
      blockedBtn: "Kirim nyata belum diaktifkan",
      ...
      errRunNotFound: "Pengiriman tak ditemukan lagi — segarkan daftar dan pilih lagi.",
      errRunCreate: "Gagal membuka pengiriman baru.",
      errSendThrew: "Kirim gagal sebelum selesai; pengiriman ditandai berhenti dengan sebabnya. Periksa pengiriman untuk detail.",
      ...
      errEnqueue: "Gagal mengantre pengiriman ke latar. Coba tekan Kirim lagi; kalau berulang, periksa log.",
      errSendInProgress: "Sudah ada pengiriman berjalan untuk segmen + template ini. Jangan mulai yang baru — itu akan mengirimi orang yang sama dua kali. Lihat progresnya di tab Kiriman, atau lanjutkan pengiriman itu di sana.",
      queuedSummary: "diantrekan ke latar",
      queuedTitle: "Pengiriman dimulai di latar",
      queuedBodyA: "Sekitar ",
      queuedBodyB: " penerima akan diproses di latar, berkelompok mengikuti batas harian — halaman ini tidak lagi ditahan selama kirim.",
      queuedWatch: "Pantau progres, hasil, dan kegagalan di tab Kiriman. Kirim mulai dalam beberapa menit; sisa yang melebihi jatah harian menunggu Anda menekan Lanjutkan di tab Kiriman.",
      sendingProgress: "Memproses pengiriman…",
      schedulingProgress: "Menjadwalkan pengiriman…",
      sendingWait: "Mohon tunggu, jangan tutup halaman ini.",
      goToKiriman: "Lihat di Kiriman",
      newCampaign: "Buat kampanye baru",
      scheduledSummary: "terjadwalkan",
      scheduledTitle: "Pengiriman terjadwal",
      scheduledWatch: "Pengiriman akan diproses otomatis pada waktu yang ditentukan. Pantau status di tab Kiriman.",
      resultTitle: "Hasil kirim",
      resRunLabelNew: "Pengiriman baru",
      resRunLabelResume: "Lanjutan pengiriman",
      resSent: "Terkirim",
      resAlreadySent: "Sudah terkirim di pengiriman ini (dilewati)",
      ...
      failBlockTitle: "{n} pengiriman GAGAL",
      failBlockAll: "Tidak ada satu pun yang berhasil dikirim. Periksa penyebab di atas sebelum mencoba lagi — mengulang tanpa memperbaiki hanya menambah baris gagal.",
      failBlockPartial: "Sebagian penerima tidak menerima pesan ini. Pengiriman ini ditandai sebagian gagal, bukan selesai.",
      failBlockHalted: "Pengiriman dihentikan otomatis setelah 20 kegagalan beruntun — itu tanda tembok di sisi penyedia, bukan 20 alamat bermasalah. Periksa dulu, baru buat pengiriman baru.",
      failCauseInvalidAddress: "Alamat tak valid",
      failCauseHardBounce: "Bounce keras",
      failCauseProviderRejected: "Ditolak penyedia (masalah penerima)",
      failCauseProviderThrottled: "Dibatasi penyedia (throttle: 429/402/503)",
      failCauseUnknown: "Tak diketahui (tanpa status HTTP)",
    },
    sendTest: {
      ...
      errSendThrew: "Kirim melempar sebelum baris pertama; pengiriman ditandai berhenti dengan sebab: ",
      errUnexpected: "Galat tak terduga saat menjalankan uji — periksa log dan pengiriman.",
    ...
    mergeData: {
      sectionTitle: "Data Mail Merge",
      sectionHint: "Template ini menggunakan placeholder kustom. Unggah CSV berisi data per penerima untuk menggantikan placeholder tersebut.",
      detectedFields: "Placeholder terdeteksi",
      noMergeFields: "Template ini tidak menggunakan placeholder kustom.",
      uploadLabel: "Unggah CSV data merge",
      uploadBtn: "Pilih file CSV",
      uploadReplace: "Ganti CSV",
      uploading: "Mengunggah…",
      uploadSuccess: "Data merge berhasil diunggah",
      uploadError: "Gagal mengunggah data merge",
      recipientCount: "penerima",
      fieldCount: "field",
      downloadTemplate: "Unduh template CSV",
      previewTitle: "Pratinjau data merge",
      clearBtn: "Hapus data merge",
      clearing: "Menghapus…",
      clearConfirm: "Yakin ingin menghapus semua data merge untuk pengiriman ini?",
      csvErrors: "Kesalahan CSV",
      required: "Data merge wajib diunggah sebelum kirim.",
    },
    drafts: {
      title: "Draf kampanye",
      empty: "Belum ada draf tersimpan.",
      saveBtn: "Simpan Draft",
      saving: "Menyimpan…",
      saved: "Draf tersimpan.",
      saveFailed: "Gagal menyimpan draf.",
      resumeBtn: "Lanjutkan",
      deleteBtn: "Hapus",
      deleteConfirm: "Hapus draf ini? Tindakan ini tidak bisa dibatalkan.",
      deleteOk: "Draf dihapus.",
      deleteFailed: "Gagal menghapus draf.",
      badge: "DRAF",
      autoSaved: "Otomatis tersimpan",
      lastSaved: "Terakhir disimpan",
      noName: "Draf tanpa nama",
      noSegment: "Belum pilih segmen",
      noTemplate: "Belum pilih template",
    },
  },
  ...
  profile: {
    ...
    editCore: {
      ...
      noteEmailDedup: "Mengganti email juga mengubah kunci dedup — pastikan email baru benar.",
      ...
      errEmailTaken: "Email ini sudah dipakai kontak lain.",
  ...
  eventAnalysis: {
    title: "Analisa Event",
    subtitle: "Ringkasan event + retensi & demografi dalam satu halaman.",
    tabOverview: "Ringkasan",
    tabRetention: "Retensi",
    ...
    subEvents: "sub-event",
    viewLabel: "Tampilan",
    viewGrouped: "Event utama",
    viewAll: "Semua event",
    quickAnswers: "Jawaban singkat",
    kpiAttended: "orang pernah ikut event 20FIT",
    kpiReturned: "kembali di event lain",
    kpiFrequent: "ikut ≥3 event · rata-rata {avg} event/orang",
    kpiAvgEvents: "rata-rata event per orang",
    attendance: "Berapa yang datang",
    thEvent: "Event",
    thSubEvent: "Sub-event",
    thVariants: "Varian",
    thNew: "Baru",
    thReturning: "Kembali",
    showTop: "Tampilkan {n} teratas",
    showAll: "Tampilkan semua ({n})",
    legendReturning: "Kembali",
    legendNew: "Baru",
    cohortTitle: "Apakah mereka balik",
    cohortDesc: "Kohort retensi per grup event — dari peserta yang event pertamanya di baris ini, berapa persen muncul lagi di event berikutnya.",
    cohortFirstEvent: "Event pertama",
    cohortPeople: "Orang",
    cohortOf: "dari",
    cohortAttendees: "peserta",
    cohortAlsoAttended: "juga ikut",
    churnTitle: "Siapa yang tidak kembali",
    churnNotReturned: "Tidak kembali",
    churnSkipReturn: "Sisi baiknya: {n} orang kembali setelah melewatkan satu event — reaktivasi mungkin dilakukan.",
    insightWeakening: "Retensi melemah: {a} → {pctA} kembali, {b} → {pctB}.",
    insightStrengthening: "Retensi menguat: {b} → {pctB} kembali (naik dari {pctA}).",
    insightHighChurn: "Churn tertinggi: {label} ({pct} tidak kembali).",
    keyInsightsTitle: "Insight Utama",
    insightCatGrowth: "Pertumbuhan & Tren",
    insightCatRetention: "Retensi",
    insightCatDemographic: "Demografi",
    insightCatAction: "Rekomendasi",
    insightGrowthLabel: "Pertumbuhan",
    insightGrowthUp: "Peserta naik {pct}% dari {prev} ke {curr}.",
    insightGrowthDown: "Peserta turun {pct}% dari {prev} ke {curr}.",
    insightTopEvent: "{label} menarik peserta terbanyak ({n} orang).",
    insightRetentionLabel: "Retensi",
    insightRetWeakening: "Retensi melemah: {a} → {pctA}% kembali, {b} → hanya {pctB}%.",
    insightRetStrengthening: "Retensi menguat: {b} → {pctB}% kembali (naik dari {pctA}%).",
    insightHighChurnNew: "Churn kritis: {pct}% peserta {label} tidak kembali.",
    insightStrongLoyalty: "{pct}% peserta kembali di event lain — loyalitas kuat.",
    insightDemographicLabel: "Demografi",
    insightGenderSkew: "Dominasi {gender} ({pct}%) — pertimbangkan event yang menarik gender lainnya.",
    insightGenderMale: "laki-laki",
    insightGenderFemale: "perempuan",
    insightTopAge: "Kelompok usia {bracket} mendominasi ({pct}% peserta).",
    insightActionLabel: "Aksi",
    insightRecLowReturn: "Hanya {pct}% kembali — buat program follow-up pasca-event (email, WA).",
    insightRecSkipReturn: "{n} orang kembali setelah melewatkan event — kirim penawaran khusus ke segmen ini.",
    insightRecSurvey: "{pct}% peserta {label} tidak kembali — lakukan survey untuk memahami alasannya.",
    insightNoData: "Belum cukup data. Tambahkan event untuk melihat insight.",
    recsTitle: "Apa yang harus dilakukan",
    dataNotes: "Catatan Data",
    dataNote1: "Sumber data digabung dari dua sumber per orang (customer_id): (1) customer_engagement WHERE unit='event' dan (2) tag event:* di master_customer.tags[].",
    dataNote2: "Sub-event terkait (JHM 5K/10K/HM, dll.) dikelompokkan otomatis berdasarkan prefix slug. Semua KPI, kohort, dan churn dihitung per grup ({groups} grup dari {events} sub-event).",
    dataNote3: "Urutan kronologis dari first_seen_at (customer_engagement). Angka \"Baru\" = event pertama seseorang, \"Kembali\" = event berikutnya.",
    recLowReturn: "Hanya {pct} yang kembali. Pertimbangkan program follow-up pasca-event (email, WhatsApp).",
    recSkipReturn: "{n} orang melewatkan satu event lalu kembali — target segmen ini dengan penawaran khusus.",
    recHighChurn: "{label} memiliki churn tertinggi ({pct}). Lakukan survey peserta yang tidak kembali.",
    recNoData: "Belum cukup data untuk rekomendasi spesifik. Tambahkan lebih banyak event untuk melihat tren.",
    printPdf: "Cetak / PDF",
    filterAllEvents: "Semua Event",
    filterEventsSelected: "{n} acara dipilih",
    filterClear: "Reset",
    filterFrom: "Dari",
    filterTo: "Sampai",
    filterPreset3m: "3 bulan terakhir",
    filterPreset6m: "6 bulan terakhir",
    filterPreset1y: "1 tahun terakhir",
    filterPresetYtd: "Tahun ini",
    filterSearchEvents: "Cari event…",
    filterActive: "Filter aktif",
    printTitle: "Laporan Analisa Event 20FIT",
    printGenerated: "Digenarasi",
    printFilterLabel: "Filter aktif:",
    demoTitle: "Demografi Peserta",
    demoGenderTitle: "Distribusi Gender per Event",
    demoGenderSummary: "{malePct} laki-laki, {femalePct} perempuan, {unknownPct} tidak diketahui dari seluruh event",
    demoMale: "Laki-laki",
    demoFemale: "Perempuan",
    demoUnknown: "Tidak diketahui",
    demoAgeTitle: "Distribusi Usia per Event",
    demoCityTitle: "Top 10 Kota",
    demoCityOther: "Lainnya",
    demoNoPeople: "Belum ada data demografi.",
    compareTitle: "Perbandingan Event",
    compareVs: "vs",
    compareTotal: "Total peserta",
    compareNew: "Baru",
    compareReturning: "Kembali",
    compareReturningPct: "% kembali",
    compareDelta: "Delta",
    compareOverlap: "Peserta di Kedua Event",
    compareBothAttended: "{n} orang ikut keduanya",
    compareOnlyA: "{n} hanya ikut {label}",
    compareOnlyB: "{n} hanya ikut {label}",
    compareOverlapPct: "{pct} peserta {label} juga ikut {other}",
    ...
    funnelTitle: "Perjalanan Peserta",
    funnelNew: "Baru",
    funnelNewDesc: "Hanya ikut 1 event",
    funnelReturning: "Kembali",
    funnelReturningDesc: "Ikut 2 event",
    funnelLoyal: "Loyal",
    funnelLoyalDesc: "Ikut 3+ event",
    funnelChurned: "Churned",
    funnelChurnedDesc: "Tidak ikut event terakhir",
    funnelConversion: "{pct}% konversi",
    funnelPeople: "{n} orang",
    categoryGrowthTitle: "Pertumbuhan per Event",
    categoryGrowthUp: "+{pct}%",
    categoryGrowthDown: "{pct}%",
    categoryGrowthFirst: "Pertama",
    overlapTitle: "Overlap Peserta Antar Event",
    overlapDesc: "Berapa banyak peserta yang ikut di kedua event — angka menunjukkan persentase dari event di baris.",
    overlapPeople: "{n} orang",
    geoTitle: "Ekspansi Geografis",
    geoDesc: "Top kota per event — badge menunjukkan kota BARU atau hilang dibanding event sebelumnya.",
    geoNew: "BARU",
    geoLost: "Hilang",
    geoConcentration: "Konsentrasi",
    geoTop1: "Top 1 kota: {pct}%",
    geoTop3: "Top 3 kota: {pct}%",
    geoHighConcentration: "Risiko konsentrasi tinggi",
  },
  ai: {
