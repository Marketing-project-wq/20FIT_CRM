...
export const id = {
  ...
  workflowsPage: {
    ...
    errRunCreate: "Gagal membuat catatan run.",
    errSendThrew: "Kirim melempar sebelum selesai — periksa detail run.",
  ...
  campaignsPage: {
    ...
    deliveries: {
      subtitle: "Satu urutan waktu: yang akan datang, sedang berjalan, selesai, dan berhenti. Sumbernya kiriman terjadwal dan run kampanye — digabung, bukan dua daftar.",
      empty: "Belum ada kiriman. Kiriman terjadwal dan run kampanye akan muncul di sini.",
      ...
      recipientWhen: "Waktu",
      detailEmpty: "Run ini belum punya baris penerima.",
    ...
    composer: {
      ...
      runAutoNew: "Belum ada run sebelumnya untuk pasangan segmen + template ini — run baru akan dibuat otomatis saat kirim.",
