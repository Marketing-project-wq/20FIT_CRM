...
export const id = {
  ...
  segments: {
    ...
    timeCriteria: {
      title: "Kriteria waktu (aktivitas nyata)",
      intro: "Berdasarkan aktivitas sungguhan di ekosistem 20FIT (arena, klinik, event, app) — bukan tanggal impor.",
      joinedA: "Bergabung dalam",
      joinedB: "hari terakhir",
      inactiveA: "Tidak aktif selama",
      inactiveB: "hari atau lebih",
      caveat: "Hanya berlaku untuk profil yang punya jejak aktivitas nyata (725 dari total). Profil tanpa jejak aktivitas tak akan cocok dengan filter waktu — ini batas cakupan data, ditampilkan jujur.",
    },
    simpleIntro: "Tambahkan filter satu per satu — tiap filter dipilih dari kategori dan nilai. Semua filter digabung dengan DAN (harus memenuhi semuanya).",
    simpleIs: "adalah",
    simpleEmpty: "Belum ada filter. Klik “Tambah filter” atau pilih segmen cepat di atas.",
    simpleAddFilter: "Tambah filter",
    ...
    srcRecencyLabel: "Punya aktivitas nyata (hanya 44 profil)",
    srcArenaLabel: "User arena (kelas / booking / paket / member)",
    srcGymLabel: "User gym (kelas / membership)",
    srcClinicPatientLabel: "Pasien klinik ",
    srcClinicPatientTag: "(butuh izin data kesehatan)",
    ...
    apiBadJson: "Body JSON tidak valid.",
    apiClinicalNeedsHealth: "Kriteria klinis butuh izin melihat data kesehatan (menyaring pasien = menyimpulkan status kesehatan).",
  ...
  quality: {
    ...
    panel: {
      ...
      ecosystemTitle: "Keikutsertaan di layanan 20FIT",
      stagingTitle: "Cakupan data impor 20FIT ★",
  ...
  workflowsPage: {
    subtitle: "Kirim otomatis yang dipicu aktivitas nyata: sambut yang baru bergabung, aktifkan lagi yang sudah diam.",
    deniedRole: "Peran Anda tidak memiliki akses ke workflow.",
    newBtn: "Workflow baru",
    newTitle: "Buat workflow",
    fieldName: "Nama",
    namePlaceholder: "mis. Sambutan member baru",
    fieldTemplate: "Template email",
    fieldType: "Tipe",
    typeWelcome: "Sambutan",
    typeReeng: "Aktivasi ulang",
    daysWelcome: "Bergabung dalam (hari)",
    daysReeng: "Tidak aktif minimal (hari)",
    coverageNote: "Trigger memakai sinyal aktivitas nyata — hanya berlaku untuk 725 profil yang punya jejak aktivitas. Dibuat non-aktif; uji dulu, lalu aktifkan.",
    createBtn: "Buat",
    cancelBtn: "Batal",
    errName: "Nama wajib diisi.",
    errCreate: "Gagal membuat workflow.",
    empty: "Belum ada workflow. Buat satu untuk memulai.",
    statusActive: "Aktif",
    statusPaused: "Jeda",
    summaryWelcome: "Sambutan · bergabung ≤ {n} hari lalu",
    summaryReeng: "Aktivasi ulang · tidak aktif ≥ {n} hari",
    enrolled: "Terdaftar",
    sent: "Terkirim",
    newlyEnrolled: "Baru terdaftar",
    justSent: "Terkirim sekarang",
    withheld: "Ditahan (pra-luncur)",
    runNow: "Jalankan sekarang",
    runFailed: "Gagal menjalankan — cek konfigurasi kirim.",
    pause: "Jeda",
    activate: "Aktifkan",
  ...
  campaignsPage: {
    ...
    testRecipientsPanel: {
      title: "Penerima uji",
      hint: "Tambahkan alamat @20fit.id di sini. Uji kirim dikirim ke semua alamat ini. Hanya alamat @20fit.id yang diterima.",
      addLabel: "Email (@20fit.id)",
      addPlaceholder: "nama@20fit.id",
      labelLabel: "Label (opsional)",
      labelPlaceholder: "mis. Tim Marketing",
      addBtn: "Tambah",
      adding: "Menambahkan…",
      errNotInternal: "Hanya alamat @20fit.id yang diterima.",
      errDenied: "Akses ditolak.",
      errFailed: "Gagal menambahkan penerima.",
      removeBtn: "Hapus",
      removing: "Menghapus…",
      removeFailed: "Gagal menghapus penerima.",
      empty: "Belum ada penerima uji. Tambahkan satu di atas.",
    ...
    steps: {
      ...
      step0Email: "Email",
      step0EmailDesc: "Kirim ke alamat email pelanggan.",
      step0Whatsapp: "WhatsApp",
      step0WhatsappDesc: "Segera hadir — integrasi WhatsApp Business sedang disiapkan.",
      step0SummaryEmail: "Email",
      step0SummaryWhatsapp: "WhatsApp",
      toStep1: "Lanjut ke Siapa",
      step1Title: "1 · Siapa",
      step1Hint: "Pilih segmen tersimpan, atau susun kriteria audiens baru.",
      step1SegmentLabel: "Segmen tersimpan",
      step1SummarySuffix: "bisa dihubungi (marketing)",
      step1CatDemografi: "Demografi",
      step1CatBehavior: "Keikutsertaan & behavior",
      ...
      toStep3: "Lanjut ke Review",
      step2TestTitle: "Uji kirim ke admin dulu",
      step3Title: "3 · Review",
      step3Hint: "Hitung berapa penerima yang akan dicapai, lalu kirim uji ke tim internal sebelum kirim ke semua audiens.",
      step3CountBtn: "Hitung penerima",
      step3SummarySuffix: "akan dikirimi",
      step3TestTitle: "Uji kirim ke admin",
      toStep4: "Lanjut ke Kirim",
      step4Title: "4 · Kirim",
      step4Hint: "Pilih run, konfirmasi, dan kirim ke semua penerima. Jumlah dihitung ulang saat kirim.",
      step4SummarySuffix: "terkirim",
    },
  ...
  profile: {
    ...
    bloodLabel: "Golongan darah (medis · butuh izin data kesehatan)",
    activityLabel: "Aktivitas nyata (my20fit)",
    activityVisitsSuffix: " kunjungan",
    activityLastActivePrefix: " · terakhir aktif ",
    clinicTitle: "Klinik — keterlibatan (butuh izin data kesehatan)",
