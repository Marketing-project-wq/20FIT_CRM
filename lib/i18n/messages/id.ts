...
export const id = {
  ...
  audit: {
    ...
    grantTitle: "Beri / ubah peran (khusus Super Admin)",
    grantDesc: "Memberi peran = memberi seluruh izin peran itu. Hanya Super Admin. Tiap pemberian tercatat di audit (role.granted, permanen).",
    grantEmail: "Email pengguna",
    grantEmailPh: "orang@20fit.id",
    grantRole: "Peran",
    grantBtn: "Beri peran",
    granting: "Memberi…",
    grantOk: "Peran diberikan: ",
    grantErrDenied: "Hanya Super Admin yang boleh memberi peran.",
    grantErrBadRole: "Peran tidak dikenal.",
    grantErrUserNotFound: "Pengguna dengan email itu tak ditemukan.",
