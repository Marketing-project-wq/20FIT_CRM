...
export const id = {
  ...
  campaignsPage: {
    ...
    deliveries: {
      ...
      retryFailedBtn: "Kirim ulang",
      retryFailedConfirm: "Kirim ulang ke {n} penerima yang gagal/antrian? Email yang sudah sampai tidak akan dikirim ulang.",
      retryFailedOk: "{n} penerima dijadwalkan untuk pengiriman ulang di latar.",
