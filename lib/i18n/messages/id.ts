...
export const id = {
  ...
  campaignsPage: {
    ...
    deliveries: {
      ...
      engagementNote: "Buka & klik belum diukur: webhook Mailtrap belum melanggan event Open dan Click, jadi kolomnya selalu kosong. Untuk mengukurnya, langganan kedua event itu di webhook lalu isi opened_at/clicked_at.",
    },
