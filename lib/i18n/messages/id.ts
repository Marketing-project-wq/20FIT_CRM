...
export const id = {
  ...
  campaignsPage: {
    ...
    composer: {
      ...
      errSendInProgress: "Kirim untuk kampanye ini sedang BERJALAN di server — buka halaman progres untuk memantaunya. Tidak dibuat pengiriman kedua (itu akan mengirim ganda ke seluruh audiens).",
      errSendStartFailed: "Tidak bisa memulai kirim — coba lagi. (Belum ada email yang dikirim.)",
    ...
    progress: {
      title: "Progres kirim",
      runningBanner: "Kirim sedang berjalan di server. Aman untuk menutup halaman ini — kirim tidak berhenti.",
      statusHeading: "Status pengiriman (dari database)",
      targetLabel: "Total sasaran",
      sentLabel: "Sudah dikirim",
      remainingLabel: "Sisa",
      rateLabel: "Kecepatan",
      rateUnit: "email/detik",
      etaLabel: "Perkiraan selesai",
      etaCalculating: "menghitung…",
      etaDone: "selesai",
      statusSending: "Sedang mengirim",
      statusSent: "Selesai — semua terkirim",
      statusPartial: "Sebagian gagal",
      statusFailed: "Gagal",
      statusStopped: "Dihentikan",
      statusDraft: "Draf",
      doneNote: "Kirim selesai. Semua angka di sini dibaca dari database — bukan dari koneksi browser.",
      notFound: "Pengiriman tak ditemukan.",
      back: "Kembali ke Campaigns",
      unknown: "—",
      loading: "Memuat…",
    },
    sendTest: {
