...
export const id = {
  ...
  campaignsPage: {
    ...
    composer: {
      ...
      campaignNameField: "Nama kampanye (opsional)",
      campaignNamePlaceholder: "mis. Newsletter Sept #1",
      campaignNameHint: "Opsional. Kalau dikosongkan, kami beri nama otomatis dari segmen dan tanggal.",
      campaignNameDefaultPre: "Kalau dikosongkan: ",
