...
export const id = {
  ...
  eventAnalysis: {
    title: "Analisa Event",
    subtitle: "Ringkasan event + retensi & nilai dalam satu halaman.",
    computed: "Dihitung",
    groups: "grup",
    subEvents: "sub-event",
    viewLabel: "Tampilan",
    ...
    revenueAvg: "Rata-rata",
    revenueMedian: "Median",
    revenueNew: "Baru",
    revenueReturning: "Kembali",
    revenuePeople: "{n} orang punya data revenue",
    revenueOverall: "Keseluruhan",
