...
export const en: Messages = {
  ...
  campaignsPage: {
    ...
    deliveries: {
      ...
      retryFailedConfirm: "Resend to {n} failed/queued recipients? Already-delivered emails won't be resent.",
      retryFailedOk: "{n} recipients scheduled for resend in the background.",
