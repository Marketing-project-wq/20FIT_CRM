...
export const en: Messages = {
  ...
  campaignsPage: {
    ...
    composer: {
      ...
      errSendInProgress: "A send for this campaign is already RUNNING on the server — open the progress page to watch it. No second send was created (that would duplicate to the whole audience).",
      errSendStartFailed: "Couldn't start the send — try again. (No email was sent yet.)",
    ...
    progress: {
      title: "Send progress",
      runningBanner: "The send is running on the server. It is safe to close this page — the send does not stop.",
      statusHeading: "Send status (from the database)",
      targetLabel: "Total target",
      sentLabel: "Sent",
      remainingLabel: "Remaining",
      rateLabel: "Rate",
      rateUnit: "emails/sec",
      etaLabel: "Estimated finish",
      etaCalculating: "calculating…",
      etaDone: "done",
      statusSending: "Sending",
      statusSent: "Done — all sent",
      statusPartial: "Partly failed",
      statusFailed: "Failed",
      statusStopped: "Stopped",
      statusDraft: "Draft",
      doneNote: "Send finished. Every number here is read from the database — never from the browser connection.",
      notFound: "Send not found.",
