...
export const en: Messages = {
  ...
  workflowsPage: {
    ...
    errRunCreate: "Could not create the run record.",
    errSendThrew: "The send threw before finishing — check the run details.",
  ...
  campaignsPage: {
    ...
    deliveries: {
      subtitle: "One timeline: upcoming, running, done, and stopped. Sourced from scheduled sends and campaign runs — merged, not two lists.",
      empty: "No deliveries yet. Scheduled sends and campaign runs will appear here.",
      ...
      recipientWhen: "Time",
      detailEmpty: "This run has no recipient rows yet.",
    ...
    steps: {
      ...
      step4Title: "4 · Send",
      step4Hint: "Pick a run, confirm, and send to all recipients. The count is re-checked at send time.",
    ...
    composer: {
      ...
      runTitle: "Send as which run?",
      runHint: "A new run re-sends to the same people (a later issue). Continuing an existing run skips anyone it already reached.",
      runResumeHeading: "Continue an existing run",
      runNewHeading: "Start a new run",
      runResumeBadge: "RESUME",
      runNewBadge: "NEW RUN",
      runNoRuns: "No run yet for this segment + template pair.",
      runAutoNew: "No earlier run exists for this segment + template — a fresh run will be created automatically when you send.",
      runUntitled: "Untitled",
      runSentSuffix: "sent in this run",
      runStatusDraft: "draft",
      runStatusSending: "in progress",
      runLabelField: "Run name (optional)",
      runLabelPlaceholder: "e.g. Newsletter Sept #1",
      runsLoading: "Loading runs…",
      runChooseFirst: "First choose: continue a run or start a new one.",
      sendNow: "Send now",
      ...
      errRunNotFound: "That run is gone — refresh the list and pick again.",
      errRunCreate: "Could not open a new run.",
      ...
      resSent: "Sent",
      resAlreadySent: "Already sent in this run (skipped)",
    ...
    sendTest: {
      ...
      errSendThrew: "The send threw before the first row; the run is marked stopped with cause: ",
      errUnexpected: "Unexpected error running the test — check the logs and the run.",
