...
export const en: Messages = {
  ...
  eventAnalysis: {
    ...
    subtitle: "Event summary + retention & value on one page.",
    computed: "Computed",
    groups: "groups",
    ...
    revenueTitle: "Revenue per Event",
    revenueTotal: "Total Revenue",
    revenueAvg: "Average",
    revenueMedian: "Median",
    revenueNew: "New",
    revenueReturning: "Returning",
    revenuePeople: "{n} people with revenue data",
    revenueOverall: "Overall",
