...
export const en: Messages = {
  ...
  templatesPage: {
    ...
    emptyBody: "Email and WhatsApp templates you create will appear here.",
    emptyFiltered: "No templates match your filters.",
    createEmail: "Create Email",
    createWhatsApp: "Create WhatsApp",
    emailSection: "Email Templates",
    whatsAppSection: "WhatsApp Templates",
    preview: "Preview",
    previewNewTab: "Preview in new tab",
    edit: "Edit",
    delete: "Delete",
    deleteConfirm: "Delete template \"{name}\"? This will hide it from the list and sending.",
    ...
    archive: "Archive",
    activate: "Activate",
    archiveConfirm: "Archive template \"{name}\"? It will be hidden from the send list.",
    ...
    displayNamePlaceholder: "Name shown in the template list",
    descriptionLabel: "Description",
    descriptionPlaceholder: "Short purpose or note about this template",
    categoryLabel: "Category",
    templateKeyLabel: "Template Key",
    templateKeyAuto: "Auto-generated from display name",
  },
  ...
  dashboard: {
    ...
    kpiHasEmail: "Has email",
    kpiTotalProfiles: "Total profiles",
    kpiBounceRate: "Bounce rate",
    kpiThisMonth: "this month",
    kpiOfTotal: "of total",
    kpiFromSnapshot: "from daily snapshot",
    kpiSuppressed: "suppressed",
    panelGrowth: "Audience growth",
    panelGrowthNote: "Cumulative profiles imported. Dots = days with new imports.",
    panelGrowthAdded: "added",
    panelGrowthEmpty: "No growth data yet.",
    panelDelivery: "Delivery health",
    panelDeliveryNote: "Email delivery stats for the last 30 days.",
    deliveryDelivered: "Delivered",
    deliveryQueued: "Queued",
    deliverySoftBounce: "Soft bounce",
    deliveryHardBounce: "Hard bounce",
    panelTopEvents: "Top 5 events",
    panelTopEventsNote: "Events with the most participants.",
    panelTopEventsEmpty: "No event data yet.",
    panelCoverage: "Contact coverage",
    panelCoverageNote: "Email and phone availability breakdown.",
    coverageBoth: "Email + phone",
    coverageEmailOnly: "Email only",
    coveragePhoneOnly: "Phone only",
    coverageNeither: "No contact",
  },
  ...
  audience: {
    ...
    addContactDesc: "Fill in the contact details. Email is required. If the email already exists, data is updated and tags are merged.",
    fldEmail: "Email",
    fldName: "Full name",
    ...
    genderL: "Male",
    genderP: "Female",
    acPhEmail: "address@email.com",
    acPhName: "Full name of the contact",
    acPhPhone: "e.g. 0812… or 62812…",
    acPhCity: "e.g. Jakarta",
    selectPlaceholder: "— choose —",
    addContactSubmit: "Save",
    addContactSubmitting: "Saving…",
    addContactCancel: "Cancel",
    addContactInserted: "New contact added.",
    addContactUpdated: "Contact already exists, data updated.",
    addContactFailed: "Failed to save contact.",
    addContactEmailRequired: "Email is required.",
    addContactNameRequired: "Name is required.",
  ...
  segments: {
    ...
    tags: {
      ...
      any: "match any",
      all: "match all",
      immediate: "Tags from an import are usable right away — no wait for the nightly mirror refresh.",
      excludeTitle: "Exclude tagged",
      searchPlaceholder: "Search tags… (e.g. sportfest)",
      chipsHeading: "Selected tags",
      include: "include",
      exclude: "exclude",
      remove: "remove",
      anyMode: "match any",
      allMode: "match all",
      modeHint: "(applies to included tags)",
      selectedOfValues: "{sel} selected · {n} values",
      peopleSuffix: "people",
      noMatch: "No tags match the search.",
    },
    ...
    aiPrimary: "the fastest way to build complex conditions",
    aiExamplesLabel: "Try:",
    quickSeeAll: "See all",
    quickSeeLess: "Collapse",
    groupProfil: "Profile",
    groupProfilHint: "Profile attributes — age, date of birth, gender, city of residence, blood type.",
    profileAge: "Age",
    profileDob: "Date of birth",
    profileGender: "Gender",
    profileBloodType: "Blood type",
    profileCityLabel: "City of residence",
    ageOpGt: "greater than",
    ageOpLt: "less than",
    ageOpEq: "equal to",
    ageOpBetween: "between",
    ageUnit: "years",
    dobOpBefore: "before",
    dobOpAfter: "after",
    dobOpBetween: "between",
    genderL: "Male",
    genderP: "Female",
    profileCaveat: "Age & date of birth are filled for only some profiles. Profiles without a date of birth will not match age/DOB filters — not a bug, but a data-coverage limit.",
    ...
    rbTagsAny: "tagged any of",
    rbTagsAll: "tagged all of",
    rbAndMore: "+{n} more",
    rbWordCity: "city",
  ...
  typoFix: {
    title: "Email Typo Fix",
    description: "Scans emails in master_customer for known typo domains (e.g. gmaol.com, gmail.con) and auto-corrects them. Only high-confidence domains are fixed; similar domains (edit distance 1) are shown for review.",
    scanBtn: "Scan",
    fixAllBtn: "Fix All",
    scanning: "Scanning emails…",
    scanFailed: "Failed to scan emails.",
    fixFailed: "Failed to fix emails.",
    fixable: "fixable",
    noTypos: "No email typos found — all domains are correct.",
    autoFixTitle: "Will Be Auto-Fixed",
    collisionTitle: "Skipped (Collision)",
    collisionDesc: "The corrected email already exists in master_customer — skipped to avoid duplicates.",
    mediumTitle: "Needs Manual Review",
    mediumDesc: "Similar domains (edit distance 1) — not auto-fixed due to medium confidence.",
    colDomain: "Wrong Domain",
    colCorrection: "Correction",
    colCount: "Count",
    fixDone: "Fix Complete",
    statFixed: "Fixed",
    statSkipped: "Skipped",
  ...
  messagesPage: {
    ...
    causeThrottled: "Provider throttled us",
  ...
  tagRegistryPage: {
    title: "Tag registry",
    intro: "Manage all operator tags. Tags marked 'Show in chart' will appear in the Event Spread chart on the Dashboard.",
    loading: "Loading tags…",
    loadFailed: "Failed to load tag registry.",
    retry: "Try again",
    ...
    showInChart: "Show in Event Spread",
    slugHint: "Format: namespace:value (e.g. event:my-event). Lowercase letters, digits, and hyphens.",
    save: "Save",
    saving: "Saving…",
    cancel: "Cancel",
    edit: "Edit",
    delete: "Delete",
    errDuplicate: "This tag is already registered.",
    errInvalidSlug: "Invalid slug format. Use namespace:value (lowercase, digits, hyphens).",
    errNetwork: "Failed to connect to the server.",
    colSlug: "Slug",
    colNamespace: "Namespace",
    colLabel: "Label",
    colChart: "Chart",
    colActions: "Actions",
    chartBadge: "Event Spread",
  ...
  campaignsPage: {
    ...
    deliveries: {
      ...
      stateDone: "Done",
      stateDoneWithNote: "Done with issues",
      statePartial: "Partly failed",
      partialNote: "{x} failed",
      stateFailed: "Failed",
      stateStopped: "Stopped",
      statePaused: "Paused (daily limit)",
      stateStalled: "Stalled? (no progress)",
      ...
      resumeBtn: "Continue",
      resumeConfirm: "Continue this send — deliver today's budget in the background?",
      resumeOk: "Resumed — sending restarts in the background within a few minutes.",
      resumeFailed: "Could not resume — it may already be finished or running. Refresh the list.",
      stopBtn: "Stop",
      stopConfirm: "Stop this send? The remaining recipients won't be emailed until you start a new send.",
      stopOk: "Stopped.",
      stopFailed: "Could not stop — it may already be finished. Refresh the list.",
      retryFailedBtn: "Retry failed",
      retryFailedConfirm: "Resend to {n} failed recipients? Already-delivered emails won't be resent.",
      retryFailedOk: "{n} failed recipients scheduled for resend in the background.",
      retryFailedFailed: "Could not schedule resend. Refresh and try again.",
      viewRecipients: "View recipients",
      backToList: "← Back to list",
      detailTitle: "Send recipients",
      recipientName: "Customer",
      recipientEmail: "Email",
      recipientUnresolved: "Unknown",
      recipientChannel: "Channel",
      recipientStatus: "Status",
      recipientSentAt: "Sent at",
      recipientDeliveredAt: "Delivered at",
      recipientOpenedAt: "Opened at",
      ...
      resSent: "Sent",
      resSentSub: "Emails sent to provider",
      resDelivered: "Delivered",
      resDeliveredSub: "Confirmed delivered to inbox",
      resOpened: "Opened",
      resClicked: "Clicked",
      resBounced: "Bounced",
      ...
      progressSent: "{x} / {y} delivered",
      progressConfirmed: "Confirmed",
      progressDelivered: "Sent",
      progressFailed: "Failed",
      progressRemaining: "Not sent yet",
      engagementNote: "Opens & clicks have not been recorded for this delivery. If the webhook subscribes Open and Click events, data will appear here once recipients engage.",
      engagementPending: "Open & click data will appear once recipients engage with the email.",
      searchPlaceholder: "Search name or email...",
      showingResults: "Showing {x} of {y} recipients",
      filterAll: "All",
    ...
    emailListSegment: {
      ...
      errTooMany: "List too long. Measured limit is 5,000 addresses per segment; split into several segments.",
      pasteLabel: "Paste list",
      uploadLabel: "Upload CSV",
      uploadHint: "CSV file — separator (comma/semicolon) auto-detected. A short list is faster to paste.",
      pickFile: "Choose CSV file",
      columnLabel: "Email column",
      columnPickHint: "The file has several columns — pick the email column.",
      previewBtn: "Preview",
      previewing: "Checking…",
      previewRead: "Addresses read",
      previewMatched: "In the pool (will be recipients)",
      previewNotInPool: "Not in the pool (will not be sent)",
      previewSuppressed: "Suppressed (counted, but won't be sent)",
      previewFailed: "Check failed. Try again.",
      previewFirst: "Preview before saving — so the recipient numbers are clear first.",
      notInPoolHint: "Addresses not yet in the pool are NOT added here (a manual segment only points at people who already exist). To add them, import first via Audience → Import.",
      snapshotNote: "An email-list segment is a SNAPSHOT: it does not grow when new people arrive later. The creation date is appended to its name automatically.",
      choiceHint: "Automatic filter for what recurs (event, role). Manual list for one-off lists (wave, time slot).",
    },
    testRecipientsPanel: {
    ...
    composer: {
      ...
      errEnqueue: "Could not queue the send to the background. Press Send again; if it keeps failing, check the logs.",
      errSendInProgress: "A send is already in progress for this segment + template. Don't start a new one — it would email the same people twice. See its progress in the Kiriman (Deliveries) tab, or continue that send there.",
      queuedSummary: "queued to background",
      queuedTitle: "Sending started in the background",
      queuedBodyA: "About ",
      queuedBodyB: " recipients will be processed in the background, in batches within the daily limit — this page is no longer held during the send.",
      queuedWatch: "Track progress, results and any failures in the Kiriman (Deliveries) tab. Sending begins within a few minutes; anything over the daily limit waits for you to press Continue in the Kiriman tab.",
      sendingProgress: "Processing your send…",
      schedulingProgress: "Scheduling your send…",
      sendingWait: "Please wait, do not close this page.",
      goToKiriman: "View in Deliveries",
      newCampaign: "Create new campaign",
      scheduledSummary: "scheduled",
      scheduledTitle: "Send scheduled",
      scheduledWatch: "The send will be processed automatically at the scheduled time. Track its status in the Kiriman (Deliveries) tab.",
      ...
      failBlockTitle: "{n} sends FAILED",
      failBlockAll: "Not a single message got through. Check the causes above before trying again — repeating without fixing anything only adds more failed rows.",
      failBlockPartial: "Some recipients did not receive this message. This send is marked partly failed, not done.",
      failBlockHalted: "The send stopped itself after 20 consecutive failures — that is a wall on the provider's side, not 20 bad addresses. Look into it before starting a new send.",
      failCauseInvalidAddress: "Invalid address",
      failCauseHardBounce: "Hard bounce",
      failCauseProviderRejected: "Provider rejected it (a recipient-level problem)",
      failCauseProviderThrottled: "Provider throttled us (429/402/503)",
      failCauseUnknown: "Unknown (no HTTP status)",
    },
    sendTest: {
    ...
    mergeData: {
      sectionTitle: "Mail Merge Data",
      sectionHint: "This template uses custom placeholders. Upload a CSV with per-recipient data to replace them.",
      detectedFields: "Detected placeholders",
      noMergeFields: "This template does not use custom placeholders.",
      uploadLabel: "Upload merge data CSV",
      uploadBtn: "Choose CSV file",
      uploadReplace: "Replace CSV",
      uploading: "Uploading…",
      uploadSuccess: "Merge data uploaded successfully",
      uploadError: "Failed to upload merge data",
      recipientCount: "recipients",
      fieldCount: "fields",
      downloadTemplate: "Download CSV template",
      previewTitle: "Merge data preview",
      clearBtn: "Clear merge data",
      clearing: "Clearing…",
      clearConfirm: "Are you sure you want to clear all merge data for this delivery?",
      csvErrors: "CSV errors",
      required: "Merge data must be uploaded before sending.",
    },
    drafts: {
      ...
      deleteOk: "Draft deleted.",
      deleteFailed: "Failed to delete draft.",
      badge: "DRAFT",
      autoSaved: "Auto-saved",
      lastSaved: "Last saved",
      noName: "Untitled draft",
  ...
  profile: {
    ...
    footer:
      "Core contact & attributes are editable by authorized roles (changes are audited) · merge & delete unavailable · email is not editable (dedup key) · opening this profile is logged once — switching tabs is not a new read · sensitive data are withheld for roles without permission (tabs are layout only).",
    editCore: {
      edit: "Edit",
      ...
      saving: "Saving…",
      cancel: "Cancel",
      ltvHandFilled: "hand-entered",
      noteBlankKeeps: "Blank fields are left unchanged. This version cannot clear a field back to empty — only replace it with another value.",
      noteEmailDedup: "Changing email also changes the dedup key — make sure the new email is correct.",
      noteFirstUnitOrigin: "“First unit” does not offer 20fit_data (a load-origin marker, not a business unit) — once changed, that value cannot be restored from here.",
      errNoChange: "No changes to save.",
      errPhoneTaken: "This phone number already belongs to another contact.",
      errEmailTaken: "This email already belongs to another contact.",
      errEmailInvalid: "Invalid email format.",
      errRowMerged: "This profile was merged into another — its data has moved.",
      errForbidden: "Your role is not authorized to change these fields.",
      errGeneric: "Save failed. Try again.",
    },
  ...
  eventAnalysis: {
    ...
    subtitle: "Event summary + retention & demographics on one page.",
    ...
    kpiAttended: "people attended a 20FIT event",
    kpiReturned: "returned at another event",
    kpiFrequent: "attended ≥3 events · avg {avg} events/person",
    kpiAvgEvents: "avg events per person",
    attendance: "Attendance",
    thEvent: "Event",
    thSubEvent: "Sub-event",
    thVariants: "Variants",
    thNew: "New",
    thReturning: "Returning",
    showTop: "Show top {n}",
    showAll: "Show all ({n})",
    legendReturning: "Returning",
    legendNew: "New",
    cohortTitle: "Did they return",
    cohortDesc: "Retention cohort by event group — of attendees whose first event is this row, what percent appeared at the next events.",
    cohortFirstEvent: "First event",
    cohortPeople: "People",
    cohortOf: "of",
    cohortAttendees: "attendees",
    cohortAlsoAttended: "also attended",
    churnTitle: "Who did not return",
    churnNotReturned: "Not returned",
    churnSkipReturn: "On the bright side: {n} people returned after skipping an event — reactivation is possible.",
    insightWeakening: "Retention weakening: {a} → {pctA} returned, {b} → {pctB}.",
    insightStrengthening: "Retention strengthening: {b} → {pctB} returned (up from {pctA}).",
    insightHighChurn: "Highest churn: {label} ({pct} did not return).",
    keyInsightsTitle: "Key Insights",
    insightCatGrowth: "Growth & Trends",
    insightCatRetention: "Retention",
    insightCatDemographic: "Demographics",
    insightCatAction: "Recommendations",
    insightGrowthLabel: "Growth",
    insightGrowthUp: "Attendance up {pct}% from {prev} to {curr}.",
    insightGrowthDown: "Attendance down {pct}% from {prev} to {curr}.",
    insightTopEvent: "{label} attracted the most attendees ({n} people).",
    insightRetentionLabel: "Retention",
    insightRetWeakening: "Retention weakening: {a} → {pctA}% returned, {b} → only {pctB}%.",
    insightRetStrengthening: "Retention strengthening: {b} → {pctB}% returned (up from {pctA}%).",
    insightHighChurnNew: "Critical churn: {pct}% of {label} attendees did not return.",
    insightStrongLoyalty: "{pct}% of attendees returned for another event — strong loyalty.",
    insightDemographicLabel: "Demographics",
    insightGenderSkew: "{gender} dominant ({pct}%) — consider events appealing to the other gender.",
    insightGenderMale: "Male",
    insightGenderFemale: "Female",
    insightTopAge: "Age group {bracket} dominates ({pct}% of attendees).",
    insightActionLabel: "Action",
    insightRecLowReturn: "Only {pct}% returned — create post-event follow-up programs (email, WA).",
    insightRecSkipReturn: "{n} people returned after skipping an event — send special offers to this segment.",
    insightRecSurvey: "{pct}% of {label} attendees did not return — survey them to understand why.",
    insightNoData: "Not enough data yet. Add events to see insights.",
    recsTitle: "What to do",
    dataNotes: "Data Notes",
    dataNote1: "Data merged from two per-person sources (by customer_id): (1) customer_engagement WHERE unit='event' and (2) event:* tags in master_customer.tags[].",
    dataNote2: "Related sub-events (JHM 5K/10K/HM, etc.) are auto-grouped by slug prefix. All KPIs, cohort, and churn are computed per group ({groups} groups from {events} sub-events).",
    dataNote3: "Chronological order from first_seen_at (customer_engagement). \"New\" = a person's first event, \"Returning\" = subsequent events.",
    recLowReturn: "Only {pct} returned. Consider post-event follow-up programs (email, WhatsApp).",
    recSkipReturn: "{n} people skipped an event then returned — target this segment with special offers.",
    recHighChurn: "{label} has the highest churn ({pct}). Survey attendees who did not return.",
    recNoData: "Not enough data for specific recommendations. Add more events to see trends.",
    printPdf: "Print / PDF",
    filterAllEvents: "All Events",
    filterEventsSelected: "{n} events selected",
    filterClear: "Reset",
    filterFrom: "From",
    filterTo: "To",
    filterPreset3m: "Last 3 months",
    filterPreset6m: "Last 6 months",
    filterPreset1y: "Last year",
    filterPresetYtd: "This year",
    filterSearchEvents: "Search events…",
    filterActive: "Filter active",
    printTitle: "20FIT Event Analysis Report",
    printGenerated: "Generated",
    printFilterLabel: "Active filters:",
    demoTitle: "Attendee Demographics",
    demoGenderTitle: "Gender Distribution per Event",
    demoGenderSummary: "{malePct} male, {femalePct} female, {unknownPct} unknown across all events",
    demoMale: "Male",
    demoFemale: "Female",
    demoUnknown: "Unknown",
    demoAgeTitle: "Age Distribution per Event",
    demoCityTitle: "Top 10 Cities",
    demoCityOther: "Other",
    demoNoPeople: "No demographic data available yet.",
    compareTitle: "Event Comparison",
    compareVs: "vs",
    compareTotal: "Total attendees",
    compareNew: "New",
    compareReturning: "Returning",
    compareReturningPct: "% returning",
    compareDelta: "Delta",
    compareOverlap: "Shared Audience",
    compareBothAttended: "{n} people attended both",
    compareOnlyA: "{n} only attended {label}",
    compareOnlyB: "{n} only attended {label}",
    compareOverlapPct: "{pct} of {label} attendees also attended {other}",
    ...
    funnelTitle: "Participant Journey",
    funnelNew: "New",
    funnelNewDesc: "Attended 1 event only",
    funnelReturning: "Returning",
    funnelReturningDesc: "Attended 2 events",
    funnelLoyal: "Loyal",
    funnelLoyalDesc: "Attended 3+ events",
    funnelChurned: "Churned",
    funnelChurnedDesc: "Did not attend latest event",
    funnelConversion: "{pct}% conversion",
    funnelPeople: "{n} people",
    categoryGrowthTitle: "Growth per Event",
    categoryGrowthUp: "+{pct}%",
    categoryGrowthDown: "{pct}%",
    categoryGrowthFirst: "First",
    overlapTitle: "Participant Overlap Between Events",
    overlapDesc: "How many attendees participated in both events — numbers show percentage of the row event.",
    overlapPeople: "{n} people",
    geoTitle: "Geographic Expansion",
    geoDesc: "Top cities per event — badges show NEW or lost cities compared to the previous event.",
    geoNew: "NEW",
    geoLost: "Lost",
    geoConcentration: "Concentration",
    geoTop1: "Top 1 city: {pct}%",
    geoTop3: "Top 3 cities: {pct}%",
    geoHighConcentration: "High concentration risk",
  },
  ai: {
