...
export const en: Messages = {
  ...
  messagesPage: {
    ...
    emptyBody: "The log fills once the first campaign runs. Real sending is still blocked until the Mailtrap token is rotated.",
  ...
  campaignsPage: {
    ...
    blockTitle: "Real sending is still blocked",
    blockBody: "Zero campaign email to customer addresses until two prerequisites are met: rotate the Mailtrap token, and set SPF/DKIM/DMARC for 20fit.id. Until then, only internal @20fit.id addresses can be sent to.",
    flowTitle: "Send flow",
    ...
    composer: {
      ...
      sendBtn: "Send",
      sending: "Sending…",
      blockedBtn: "Sending blocked (token not rotated)",
