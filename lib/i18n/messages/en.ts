...
export const en: Messages = {
  ...
  campaignsPage: {
    ...
    composer: {
      ...
      noSegments: "No saved segments yet. Save one on the Segments screen.",
      ...
      campaignNameField: "Campaign name (optional)",
      campaignNamePlaceholder: "e.g. Newsletter Sept #1",
      campaignNameHint: "Optional. If left blank, we name it automatically from the segment and the date.",
      campaignNameDefaultPre: "If left blank: ",
