...
export const en: Messages = {
  ...
  audit: {
    ...
    grantTitle: "Grant / change a role (Super Admin only)",
    grantDesc: "Granting a role grants all of that role's permissions. Super Admin only. Every grant is audited (role.granted, permanent).",
    grantEmail: "User email",
    grantEmailPh: "person@20fit.id",
    grantRole: "Role",
    grantBtn: "Grant role",
    granting: "Granting…",
    grantOk: "Role granted: ",
    grantErrDenied: "Only a Super Admin may grant roles.",
    grantErrBadRole: "Unknown role.",
    grantErrUserNotFound: "No user found with that email.",
