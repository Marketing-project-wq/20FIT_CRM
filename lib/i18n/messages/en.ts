...
export const en: Messages = {
  ...
  campaignsPage: {
    ...
    steps: {
      step1Title: "1 · Who",
      step1Hint: "Pick a saved segment, or build a new one. The exact recipient count (after suppression) appears in the Message step.",
      step1SegmentLabel: "Saved segment",
      step1SummarySuffix: "contactable (marketing)",
      step1BuildNew: "Build a new segment",
