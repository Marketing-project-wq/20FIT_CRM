...
const DELIVERIES: DeliveryRow[] = [
  { kind: "scheduled", id: "d1", runId: null, label: "gmail test · 31 Agu 2026", ownerName: "gmail test", source: "manual", templateKey: "welcome", recipientCount: 36, failedCount: 0, sentCount: 0, deliveredCount: 0, bouncedCount: 0, openedCount: 0, clickedCount: 0, state: "upcoming", time: "2026-09-02T02:00:00Z", cancellable: true, resumable: false, stoppable: false, lastError: null },
  { kind: "scheduled", id: "d2", runId: null, label: "Peserta RUNFEST · 30 Agu 2026", ownerName: "Peserta RUNFEST punya email", source: "manual", templateKey: "welcome", recipientCount: 11546, failedCount: 0, sentCount: 0, deliveredCount: 0, bouncedCount: 0, openedCount: 0, clickedCount: 0, state: "overdue", time: "2026-08-30T06:00:00Z", cancellable: true, resumable: false, stoppable: false, lastError: null },
  ...
  { kind: "run", id: "d3", runId: "r3", label: "Member gym aktif · 29 Agu 2026", ownerName: "Member gym aktif", source: "manual", templateKey: "welcome", recipientCount: 812, failedCount: 3, sentCount: 200, deliveredCount: 300, bouncedCount: 2, openedCount: 87, clickedCount: 23, state: "running", time: "2026-08-31T01:00:00Z", cancellable: false, resumable: false, stoppable: true, lastError: null },
  // d8: a campaign run PAUSED at today's daily budget (P0-3) — leftover waits for a human, so it
  // offers both "Lanjutkan" and "Hentikan".
  { kind: "run", id: "d8", runId: "r8", label: "Broadcast Sept #2 · 24 Agu 2026", ownerName: "Semua member", source: "manual", templateKey: "welcome", recipientCount: 1000, failedCount: 0, sentCount: 150, deliveredCount: 450, bouncedCount: 1, openedCount: 112, clickedCount: 34, state: "paused", time: "2026-08-24T02:00:00Z", cancellable: false, resumable: true, stoppable: true, lastError: null },
  ...
  { kind: "run", id: "d9", runId: "r9", label: "Blast member baru · 23 Agu 2026", ownerName: "Member baru", source: "manual", templateKey: "welcome", recipientCount: 3200, failedCount: 0, sentCount: 1800, deliveredCount: 0, bouncedCount: 0, openedCount: 0, clickedCount: 0, state: "stalled", time: "2026-08-23T02:00:00Z", cancellable: false, resumable: false, stoppable: true, lastError: null },
  { kind: "run", id: "d4", runId: "r4", label: "Reaktivasi app · 28 Agu 2026", ownerName: "Alur reaktivasi", source: "auto", templateKey: "reactivate", recipientCount: 1500, failedCount: 0, sentCount: 0, deliveredCount: 1500, bouncedCount: 0, openedCount: 420, clickedCount: 95, state: "done", time: "2026-08-28T03:00:00Z", cancellable: false, resumable: false, stoppable: false, lastError: null },
  { kind: "run", id: "d5", runId: "r5", label: "Broadcast Sept #1", ownerName: "Semua member", source: "manual", templateKey: "welcome", recipientCount: 240, failedCount: 12, sentCount: 30, deliveredCount: 150, bouncedCount: 8, openedCount: 41, clickedCount: 7, state: "stopped", time: "2026-08-27T04:00:00Z", cancellable: false, resumable: false, stoppable: false, lastError: "bounce keras > 5% (auto-stop reputasi domain)" },
  // The two states added with T-42, so the markers are visible here before they occur in production.
  { kind: "run", id: "d6", runId: "r6", label: "Ajakan tiket · 26 Agu 2026", ownerName: "Peserta event", source: "manual", templateKey: "welcome", recipientCount: 18243, failedCount: 18119, sentCount: 0, deliveredCount: 100, bouncedCount: 24, openedCount: 18, clickedCount: 3, state: "partial", time: "2026-08-26T07:00:00Z", cancellable: false, resumable: false, stoppable: false, lastError: null },
  { kind: "run", id: "d7", runId: "r7", label: "Promo akhir pekan · 25 Agu 2026", ownerName: "Member gym aktif", source: "manual", templateKey: "welcome", recipientCount: 640, failedCount: 640, sentCount: 0, deliveredCount: 0, bouncedCount: 0, openedCount: 0, clickedCount: 0, state: "failed", time: "2026-08-25T09:00:00Z", cancellable: false, resumable: false, stoppable: false, lastError: "stopped_consecutive_failures failed_total=640 top_cause=provider_throttled" },
];
