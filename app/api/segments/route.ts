  ...
  const { error: auditError } = await admin.from("crm_audit_log").insert({
    ...
    metadata: {
      ...
      criteria: {
        ...
        joined_within_days: criteria.joinedWithinDays,
        inactive_for_days: criteria.inactiveForDays,
        age_op: criteria.ageOp,
        age_min: criteria.ageMin,
        age_max: criteria.ageMax,
        dob_op: criteria.dobOp,
        dob_start: criteria.dobStart,
        dob_end: criteria.dobEnd,
        gender: criteria.gender,
        blood_type: criteria.bloodType,
        profile_city: criteria.profileCity,
